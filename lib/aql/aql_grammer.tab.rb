...
module_eval(<<'...end aql_grammer.rb/module_eval...', 'aql_grammer.rb', 38)
...
...end aql_grammer.rb/module_eval...
...
module_eval(<<'.,.,', 'aql_grammer.rb', 21)
  def _reduce_3(val, _values)
     '=' 
  end
.,.,

module_eval(<<'.,.,', 'aql_grammer.rb', 25)
  def _reduce_4(val, _values)
     val[0] 
  end
.,.,

module_eval(<<'.,.,', 'aql_grammer.rb', 29)
